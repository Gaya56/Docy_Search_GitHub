...
TOOL_SERVER_MAP = {
    "web_search": lambda: MCPServerStdio('python', ['brave_search.py'], tool_prefix="web"),
    # Temporarily disabled due to aiohttp dependency conflicts
    # "github_search": lambda: MCPServerStdio('python', ['github_mcp_server.py']),
    "python_tools": lambda: MCPServerStdio('python', ['python_tools.py'], tool_prefix="py"),
    "tool_recommend": lambda: MCPServerStdio('python', ['tool_recommendation/mcp_server.py'], tool_prefix="rec"),
    "data_viz": lambda: MCPServerStdio('python', ['python_tools.py'], tool_prefix="viz")  # Same server, different prefix
}
