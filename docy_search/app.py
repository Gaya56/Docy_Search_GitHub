...
TOOL_SERVER_MAP = {
    "websearch": lambda: MCPServerStdio(
        'python', ['-m', 'docy_search.tool_recommendation.brave_search'],
        tool_prefix="web"
    ),
    "web_search": lambda: MCPServerStdio(
        'python', ['-m', 'docy_search.tool_recommendation.brave_search'],
        tool_prefix="web"
    ),
    "python_tools": lambda: MCPServerStdio(
        'python', ['-m', 'docy_search.tool_recommendation.python_tools'],
        tool_prefix="py"
    ),
    "tool_recommendation": lambda: MCPServerStdio(
        'python', ['-m', 'docy_search.tool_recommendation.mcp_server'],
        tool_prefix="rec"
    ),
    "tool_recommend": lambda: MCPServerStdio(
        'python', ['-m', 'docy_search.tool_recommendation.mcp_server'],
        tool_prefix="rec"
    ),
    "github_search": lambda: MCPServerStdio(
        'python', ['-m', 'docy_search.tool_recommendation.github_mcp_server'],
        tool_prefix="github"
    ),
    "data_viz": lambda: MCPServerStdio(
        'python', ['-m', 'docy_search.tool_recommendation.python_tools'],
        tool_prefix="viz"
    )
}
